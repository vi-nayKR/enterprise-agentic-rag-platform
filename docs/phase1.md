...
## Step 0: Environment Setup & Tooling Architecture
...
## Step 1.2: Recursive Semantic Chunking (`src/rag/chunking.py`)
...
### Why We Built an Offline Resilient Fallback:
...
## Step 1.4: Dual Storage Engine — Dense + Sparse (`src/rag/document_store.py`)
